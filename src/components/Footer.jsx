        ...
        <div className="container bg-dark" id="foot">
            <footer className="py-5">
              <div className="row">
                ...
                <div className="col-lg-2 col-xs-10">
                  ...
                  <ul className="nav flex-column">
                    ...
                    <a href="/" className="nav-link p-0" style={{color: "inherit"}}>Book Reviews</a>
                    </li>
                    <li className="nav-item mb-2">
                    <Link to="/about" className="nav-link p-0" style={{color: "inherit"}}>Podcasts Decoded</Link>
                    </li>
                    <li className="nav-item mb-2">
                    <Link to="/contact" className="nav-link p-0" style={{color: "inherit"}}>Blog Snippets</Link> </li>
                    <li className="nav-item mb-2">
              ...
              <div className="d-flex justify-content-between py-4 my-4 border-top">
                <p>&copy; {year} ėnvolve. All rights reserved.</p>
